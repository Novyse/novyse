...
void main() {
  group('Local Chat Search Tests', () {
    testWidgets('filterChatsByQuery filters chats correctly by name or handle', (tester) async {
    ...
    test('filterRemoteChats excludes remote chats that match local uuid or handle', () {
      const local = [
        ChatModel(
          uuid: 'uuid-1',
          name: 'Local User',
  ...
  group('ChatSearchResults Widget Tests', () {
    testWidgets('renders ChatSearchResults with local and global chat sections', (tester) async {
