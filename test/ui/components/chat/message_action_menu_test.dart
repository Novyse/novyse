...
void main() {
  ...
  group('MessageActionMenu Widget Tests', () {
    ...
    testWidgets('renders all author actions when local user is sender', (tester) async {
    ...
    testWidgets('does not render Delete or Edit for non-author without delete permissions', (tester) async {
      final container = ProviderContainer(
        overrides: [
          userStoreProvider.overrideWith(() => FakeUserNotifier('other-user')),
        ],
      );
      addTearDown(container.dispose);
    ...
    testWidgets('does not render Pin when member lacks pinMessage permission in group', (tester) async {
    ...
    testWidgets('allows non-author admin with deleteMessage permission and level >= author level to delete message', (tester) async {
        ...
        roles: [
          {
            ...
            'permission': (ChatPermissions.readMessage |
    ...
    testWidgets('does not allow non-author admin to delete if role level is lower than author level', (tester) async {
      final chatWithRoles = ChatModel(
        uuid: 'chat-abc',
        name: 'Community',
        type: 'GROUP',
    ...
    testWidgets('does not allow non-author to delete another message in DM even with delete permission', (tester) async {
    ...
    testWidgets('hides Reply in ANNOUNCE channel for regular user', (tester) async {
