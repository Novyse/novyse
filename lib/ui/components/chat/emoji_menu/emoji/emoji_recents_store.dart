...
///
/// Mirrors the legacy `novyse-recent-emojis` AsyncStorage key (max 24) and the
/// [GifRecentsStore] pattern. Stores raw emoji chars so skin-tone variants
/// are remembered exactly as picked.
